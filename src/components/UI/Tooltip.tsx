...
export default function Tooltip({
	...
	return (
		<div className={`relative flex ${className}`}>
			...
			{isVisible && (
				<div
					className={`hidden md:block select-none absolute z-50 bg-foreground text-white text-xs text-center p-2 rounded-md top-full left-1/2 transform -translate-x-1/2 mt-2 shadow-lg animate-fadeIn min-w-max ${
